...
subtest 'Run without overriding any technical values' => {
    ...
    $input.add-multi-input('Test::SubTest::SubModule', 'Monkey A', '', 'kids', 5);
    $input.add-multi-input('Test::SubTest::SubModule', 'Monkey B', '', 'kids', 3);
    $input.add-multi-input('Test::SubTest::SubModule', 'Monkey C', '', 'kids', 7);
