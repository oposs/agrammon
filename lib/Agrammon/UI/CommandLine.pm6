...
#| Run the model
multi sub MAIN('run', Str $filename, ExistingFile $input, ExistingFile :$cfg-file, Str :$technical-file,
...
#| Validate inputs
multi sub MAIN(
        'validate', Str $filename, ExistingFile $input, ExistingFile :$cfg-file,
